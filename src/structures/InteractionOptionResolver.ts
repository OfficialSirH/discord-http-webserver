...
export class InteractionOptionResolver {
   ...
   * @example
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   ...
   */
  public get(name: string, throwIfNotHere: true): InteractionOption;
  public get(name: string): InteractionOption | undefined;
   ...
   */
  public getSubcommandGroup(throwIfNotHere: true): string;
   ...
   */
  public getSubcommand(throwIfNotHere: true): string;
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const option = options.getString('optionName');
   * }
   * ```
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const option = options.getInteger('optionName');
   * }
   * ```
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const option = options.getNumber('optionName');
   * }
   * ```
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const value = options.getUser('optionName');
   * }
   * ```
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const value = options.getChannel('optionName');
   * }
   * ```
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const value = options.getRole('optionName');
   * }
   * ```
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const value = options.getMentionable('optionName');
   * }
   * ```
   ...
   * ```typescript
   * public chatInputRun(reply: FastifyReply, interaction: APIChatInputApplicationCommandInteraction, options: InteractionOptionResolver) {
   *  const value = options.getAttachment('optionName');
   * }
   * ```
   ...
   */
  public getAttachment(name: string, throwIfNotHere: true): APIAttachment;
   ...
   * @example
   * ```typescript
   * public contextMenuRun(reply: FastifyReply, interaction: APIApplicationCommandContextMenuInteraction, options: InteractionOptionResolver) {
  ...
  public getMessage(throwIfNotHere = false): APIMessage | undefined {
    ...
    if (!resolved) {
      if (throwIfNotHere) throw new Error('Message option not found');
      return undefined;
    }
    return resolved;
  }
   ...
   * @example
   * ```typescript
   * public autocompleteRun(reply: FastifyReply, interaction: APIApplicationCommandAutocompleteInteraction, options: InteractionOptionResolver) {
  ...
  public getFocused(throwIfNotHere = false, wholeOption = false): InteractionOption | string | number | undefined {
    ...
    if (!focused) {
      if (throwIfNotHere) throw new Error('Focused option not found');
      return undefined;
    }
